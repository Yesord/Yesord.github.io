<!doctype html> <!-- 文档类型 -->
<html lang="en"> <!-- 语言 -->
    <head><!-- hexo injector head_begin start --><meta name="description" content="010101110110111001"></meta><meta name="keywords" content="tech, Blog"></meta><meta name="author" content="Yesord"></meta><!-- hexo injector head_begin end --><meta charset="utf-8"> <!-- 字符集 -->
        ...
        <body id="body-container">
            ...
            <div id="app">
            </div><!-- hexo injector body_end start --><script src="https://fastly.jsdelivr.net/gh/Yesord/live2d-widget@latest/autoload.js"></script><!-- hexo injector body_end end --></body></script></html> 